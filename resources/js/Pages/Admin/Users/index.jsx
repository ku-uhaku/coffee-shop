		...
		<AdminLayout header="Users">
			...
			<Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="User Details">
				{selectedUser && (
					<div className="space-y-4">
						<p>
							<span className="font-semibold">Name:</span> {selectedUser.first_name}{" "}
			...
			>
				<p className="text-sm text-gray-500">
					Are you sure you want to delete {selectedIdsForBulkDelete.length} users? This action cannot be
					undone.
				</p>
			</Modal>
			<Modal
